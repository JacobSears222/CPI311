...
namespace Assignment4
{
    public class Assignment4 : Game
    {
        ...
        {
            // NormalMaps
            //if (Keyboard.GetState().IsKeyDown(Keys.D1)) texture = 0;
            //if (Keyboard.GetState().IsKeyDown(Keys.D2)) texture = 1;
            //if (Keyboard.GetState().IsKeyDown(Keys.D3)) texture = 2;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                int i = 0;
                spriteBatch.DrawString(font, "Particle Total Time " + particleTotalTime, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Emission Shape (F4) " + emissionShape, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Paticle Max number " + particleMaxNum, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Paticle Emission Num (N) " + particleEmissionNum, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Paticle Emission Span (E) " + particleEmissionSpan, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Paticle Max Age (A) " + particleMaxAge, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Particle Bounce Option (B) " + particleBoundON, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Paticle Resilience (R) " + particleResilience, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Particle Friction " + particleFriction, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Wind Direction (D) " + particleWindDirection, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Particle Speed (W) " + particleSpeed, Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
                spriteBatch.DrawString(font, "Emission Size (S) " + emissionSize.ToString("0.000"), Vector2.UnitX * 400 + Vector2.UnitY * 15 * (i++), Color.White);
            }
            spriteBatch.End();
